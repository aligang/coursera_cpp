...
void check_symbols_prior_next_number(istream& input_string_stream, string& input_string){
...
istream& operator>>(istream& input_stream, Date& date){
	...
	check_symbols_prior_next_number(input_string_stream, input_string);
	input_string_stream >> month;
	check_symbols_prior_next_number(input_string_stream, input_string);
	input_string_stream >> day;
	if (!input_string_stream.eof()){
		throw runtime_error("Wrong date format: " + input_string);
	}
